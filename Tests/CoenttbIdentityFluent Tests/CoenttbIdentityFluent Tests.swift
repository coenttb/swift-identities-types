//  CoenttbIdentityFluent Tests.swift
...
@Suite(
    "CoenttbIdentityFluent Creation Tests",
...
struct IdentityLiveTests {
    ...
    func testCreateAccountSuccess() async throws {
        ...
        let client = CoenttbIdentity.Client<TestUser>.liveTest
...
@Suite(
    "CoenttbIdentityFluent EmailChange Tests",
    .dependency(\.application, ApplicationKey.testValue)
)
struct EmailChange {
    ...
    func testEmailChangeRequestFailsWithoutReauth() async throws {
        ...
        await #expect(throws: CoenttbIdentity.Client<TestUser>.RequestEmailChangeError.self) {
    ...
    func testEmailChangeRequestSucceedsWithReauth() async throws {
        ...
        let newEmail = try EmailAddress("new@example.com")
        await #expect(throws: CoenttbIdentity.Client<TestUser>.RequestEmailChangeError.unauthorized) {
