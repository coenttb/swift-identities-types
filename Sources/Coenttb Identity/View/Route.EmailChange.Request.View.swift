        ...
        public var body: some HTML {
            PageModule(theme: .login) {
                VStack {
                    ...
                    form {
                        VStack {
                            Input.default(Coenttb_Identity.API.EmailChange.Request.CodingKeys.newEmail)
                                .type(.email)
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                form.addEventListener('submit', async function(event) {
                    ...
                    const newEmail = formData.get('\#(Coenttb_Identity.API.EmailChange.Request.CodingKeys.newEmail.rawValue)');
