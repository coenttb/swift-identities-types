        ...
        public var body: some HTML {
            PageModule(theme: .login) {
                VStack {
                    ...
                    form {
                        VStack {
                            Input.default(Coenttb_Identity.API.Password.Change.Request.CodingKeys.currentPassword)
                                .type(.password)
                                .placeholder(TranslatedString(dutch: "Huidig wachtwoord", english: "Current password").description)
                            
                            Input.default(Coenttb_Identity.API.Password.Change.Request.CodingKeys.newPassword)
                                .type(.password)
