        ...
        public var body: some HTML {
            PageModule(theme: .login) {
                ...
                VStack {
                    ...
                    form {
                        VStack {
                            Input.default(Coenttb_Identity.API.Password.Reset.Request.CodingKeys.email)
                                .type(.email)
                                .placeholder("Email")
                                .focusOnPageLoad()
                ...
                VStack {
                    ...
                    form {
                        VStack {
                            ...
                            Input.default(Coenttb_Identity.API.Password.Reset.Confirm.CodingKeys.newPassword)
                                .type(.password)
            ...
            script {"""
               document.addEventListener('DOMContentLoaded', function() {
                   ...
                   form.addEventListener('submit', async function(event) {
                       ...
                       const formData = new FormData(form);
                       const password = formData.get('\(Coenttb_Identity.API.Password.Reset.Confirm.CodingKeys.newPassword.rawValue)');
                       ...
                       try {
                           ...
                           const response = await fetch(form.action, {
                               ...
                               body: new URLSearchParams({
                                    \(Coenttb_Identity.API.Password.Reset.Confirm.CodingKeys.token.rawValue): '\(self.token)',
                                    \(Coenttb_Identity.API.Password.Reset.Confirm.CodingKeys.newPassword.rawValue): password
                               }).toString()
                           });
