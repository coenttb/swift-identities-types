...
public struct ConfirmAccess<CodingKey: RawRepresentable>: HTML where CodingKey.RawValue == String {
    ...
    public init(
        codingKey: CodingKey = Coenttb_Identity.API.EmailChange.Reauthorization.CodingKeys.password,
...
@MainActor let confirmAccess: some HTML = ConfirmAccess(
    codingKey: Coenttb_Identity.API.Create.Request.CodingKeys.password,
