...
extension CoenttbIdentity.Client {
            ...
            emailChange: .init(
                request: { newEmail in
                    ...
                    do {
                        ...
                        else { throw CoenttbIdentity.Client<User>.RequestEmailChangeError.unauthorized }
                        ...
                        guard let newEmail
                        else { throw CoenttbIdentity.Client<User>.RequestEmailChangeError.emailIsNil }
