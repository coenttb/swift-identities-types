...
extension Identity.Creation {
    ...
    public func request(email: String, password: String) async throws -> Void {
    ...
    public func request(_ request: Identity.Creation.Request) async throws -> Void {
    ...
    public func verify(email: String, token: String) async throws -> Void {
    ...
    public func verify(_ verification: Identity.Creation.Verification) async throws -> Void {
...
extension Identity.Password.Reset {
    ...
    public func request(email: String) async throws -> Void {
    ...
    public func request(_ request: Identity.Password.Reset.Request) async throws -> Void {
        try await self.client.request(request)
    }
    ...
    public func confirm(newPassword: String, token: String) async throws -> Void {
    ...
    public func confirm(_ confirm: Identity.Password.Reset.Confirm) async throws -> Void {
...
extension Identity.Password.Change {
    ...
    ///   - newPassword: The new password to set
    public func request(currentPassword: String, newPassword: String) async throws -> Void {
    ...
    public func request(_ request: Identity.Password.Change.Request) async throws -> Void {
        try await self.client.request(request)
    }
}
...
extension Identity.Email.Change {
    ...
    /// - Returns: Response containing updated authentication information
    public func confirm(_ confirmation: Identity.Email.Change.Confirmation) async throws -> Identity.Email.Change.Confirmation.Response {
...
extension Identity.Deletion {
    ...
    public func request(reauthToken: String) async throws -> Void {
    ...
    public func request(_ request: Identity.Deletion.Request) async throws -> Void {
        try await self.client.request(request)
    }
    ...
    public func confirm() async throws -> Void {
...
extension Identity.Authentication {
    ...
    ///   - password: The user's password
    /// - Returns: An authentication response containing access and refresh tokens
    public func credentials(username: String, password: String) async throws -> Identity.Authentication.Response {
