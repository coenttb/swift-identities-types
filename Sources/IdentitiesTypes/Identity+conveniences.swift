...
extension Identity {
    ...
    public func login(refreshToken: String) async throws(Identity.Authentication.Token.Client.Error) -> Identity.Authentication.Response {
    ...
    /// - Returns: An authentication response containing access and refresh tokens
    public func login(apiKey: String) async throws(Identity.Authentication.Client.Error) -> Identity.Authentication.Response {
...
extension Identity.Creation {
    ...
    public func request(email: String, password: String) async throws(Identity.Creation.Client.Error) {
    ...
    public func verify(_ verification: Identity.Creation.Verification) async throws(Identity.Creation.Client.Error) {
...
extension Identity.Password.Reset {
    ...
    public func confirm(newPassword: String, token: String) async throws(Identity.Password.Reset.Client.Error) {
...
extension Identity.Password.Change {
    ...
    ///   - newPassword: The new password to set
    public func request(currentPassword: String, newPassword: String) async throws(Identity.Password.Change.Client.Error) {
...
extension Identity.Email.Change {
    ...
    public func request(newEmail: String) async throws(Identity.Email.Change.Client.Error) -> Identity.Email.Change.Request.Result {
    ...
    public func confirm(token: String) async throws(Identity.Email.Change.Client.Error) -> Identity.Email.Change.Confirmation.Response {
...
extension Identity.Reauthorization {
    ...
    public func reauthorize(password: String) async throws(Identity.Reauthorization.Client.Error) -> JWT {
...
extension Identity.Authentication {
    ...
    /// - Returns: An authentication response containing access and refresh tokens
    public func apiKey(_ apiKey: String) async throws(Identity.Authentication.Client.Error) -> Identity.Authentication.Response {
