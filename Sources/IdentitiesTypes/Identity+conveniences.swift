...
extension Identity {
    ...
    public func login(accessToken: String) async throws(any Swift.Error) {
        // swiftlint:enable no_any_protocol_existential
...
extension Identity {
    // swiftlint:disable no_any_protocol_existential - DI witness-closure type erasure ([API-ERR-006]/[#219] class) — pluggable client boundary; see issue #9 disposition
    public func logout() async throws(any Swift.Error) {
        // swiftlint:enable no_any_protocol_existential
...
extension Identity.Creation {
    ...
    public func request(email: String, password: String) async throws(any Swift.Error) {
        // swiftlint:enable no_any_protocol_existential
    ...
    public func verify(email: String, token: String) async throws(any Swift.Error) {
        // swiftlint:enable no_any_protocol_existential
...
extension Identity.Password.Reset {
    ...
    public func request(email: String) async throws(any Swift.Error) {
        // swiftlint:enable no_any_protocol_existential
    ...
    public func confirm(newPassword: String, token: String) async throws(any Swift.Error) {
        // swiftlint:enable no_any_protocol_existential
...
extension Identity.Deletion {
    ...
    public func request(reauthToken: String) async throws(any Swift.Error) {
        // swiftlint:enable no_any_protocol_existential
    ...
    public func cancel() async throws(any Swift.Error) {
        // swiftlint:enable no_any_protocol_existential
    ...
    public func confirm() async throws(any Swift.Error) {
        // swiftlint:enable no_any_protocol_existential
...
extension Identity.Reauthorization {
    ...
    public func reauthorize(password: String) async throws(any Swift.Error) -> JWT {
        // swiftlint:enable no_any_protocol_existential
