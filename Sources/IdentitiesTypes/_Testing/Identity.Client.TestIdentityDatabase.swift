//
//  Identity.Client._TestDatabase.swift
//  swift-identities
//
...
extension Identity.Client._TestDatabase: TestDependencyKey {
    package static var testValue: Identity.Client._TestDatabase = .init()
    package static var testValue2: Identity.Client._TestDatabase = .init()
}
