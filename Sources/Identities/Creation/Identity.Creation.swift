...
extension Identity.Creation.Request {
   /// Router for handling identity creation request endpoints.
   ///
...
extension Identity.Creation.Verification {
   /// Router for handling identity verification endpoints.
   ///
   /// Routes POST requests to the "/verify" path with form-encoded body.
   public struct Router: ParserPrinter, Sendable {
       public init() {}
