...
extension Session {
    var identityVersion: Int? {
        get { data[Identity.FieldKeys.sessionVersion.description].flatMap(Int.init) }
        set { data[Identity.FieldKeys.sessionVersion.description] = newValue.map(String.init) }
    }
}
