...
public struct ConfirmAccess<CodingKey: RawRepresentable>: HTML where CodingKey.RawValue == String {
    ...
    public init(
        codingKey: CodingKey = CoenttbIdentity.API.EmailChange.Reauthorization.CodingKeys.password,
...
@MainActor let confirmAccess: some HTML = ConfirmAccess(
    codingKey: CoenttbIdentity.API.Create.Request.CodingKeys.password,
