    ...
    public struct Request: HTML {
        ...
        public var body: some HTML {
            PageModule(theme: .login) {
                form {
                    VStack {
                        Input.default(CoenttbIdentity.API.Create.Request.CodingKeys.email)
                            .type(.email)
                            .placeholder(String.email.description)
                            .focusOnPageLoad()
                        
                        Input.default(CoenttbIdentity.API.Create.Request.CodingKeys.password)
                            .type(.password)
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                form.addEventListener('submit', async function(event) {
                    ...
                    const email = formData.get('\(CoenttbIdentity.API.Create.Request.CodingKeys.email.rawValue)');
                    const password = formData.get('\(CoenttbIdentity.API.Create.Request.CodingKeys.password.rawValue)');
                    ...
                    try {
                        const response = await fetch(form.action, {
                            ...
                            body: new URLSearchParams({
                                 \(CoenttbIdentity.API.Create.Request.CodingKeys.email.rawValue): email,
                                 \(CoenttbIdentity.API.Create.Request.CodingKeys.password.rawValue): password
                            }).toString()
                        });
